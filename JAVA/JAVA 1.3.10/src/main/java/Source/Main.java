...
public class Main extends Application {
    ...
    /**
     * <h1>Automatic vehicle location representer v1.3.10</h1>
    ...
    public void start(Stage primaryStage) {
        ...
        LOGGER.info("\nAutomatic vehicle location representor v1.3.10 started...");
        ...
        primaryStage.setTitle("Automatic vehicle location representer v1.3.10");
