...
public class AVLRecord implements Serializable {
    ...
    public AVLRecord(ByteReader byteReader,int codec) {
    ...
    private RecordHeaderModel ReadRecord_Header() {
        ...
        return headerParser.ReadRecordHeader();
    }
    ...
    private RecordGpsModel ReadRecord_GPS() {
        ...
        recordGpsModel = gpsParser.ReadRecordGPS();
    ...
    private RecordIoModel ReadRecord_IO(int codec) {
        ...
        IOParser ioParser = new IOParser(ioIdSize, byteReader);
        return ioParser.GetElement();
    }
